    ...
    public partial class FaceDetect : Form
    {
        ...
        {
            {
                ...
                if (action == "CLOCK IN")
                {
                    ...
                    if (isRecorded)
                    {
                        AutoClosingMessageBox.Show("CLOCK IN has been successfully recorded", "Successful", 5000);
                        lblStatus.Text = "CLOCK IN";
                    }
                    else
                ...
                else if (action == "LUNCH START")
                {
                    ...
                    if (isRecorded)
                    {
                        lblStatus.Text = "CLOCK OUT";
                        AutoClosingMessageBox.Show("CLOCK OUT has been successfully recorded", "Successful", 5000);
                    }
                    else
        ...
        public void SetActiveClockButton()
        {
            ...
            if (result != null && result.Rows.Count > 0)
            {
                ...
                {
                    button1.Text = "LUNCH START";
                    return;
                }

                if (result.Rows[0]["lunch_end"] == DBNull.Value)
                {
                    button1.Text = "LUNCH END";
                    return;
                }
